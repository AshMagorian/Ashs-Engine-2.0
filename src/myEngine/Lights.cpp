...
Lights::Lights()
{
	m_directionalLight->ambient = glm::vec3(0.04f, 0.04f, 0.11f);
	m_directionalLight->diffuse = glm::vec3(0.15f, 0.15f, 0.35f);
	m_directionalLight->specular = glm::vec3(0.2f, 0.2f, 0.2f);
